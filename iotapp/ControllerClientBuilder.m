...
withFilterContext:(id)filterContext
{
    ...
    if(data.length < 5){
        ...
        if(command[0] == 0x00){
            ...
            //[_udpSocket sendData:connectData toHost:controllerHost port:controllerPort withTimeout:-1 tag:clock()];
